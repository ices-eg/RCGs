...
######################################################
#
pathIn     <-    'Q:/mynd/RCM/RCGs/NWPtools/table_2_1'
...
whatGoesIn <-    list(EUROSTAT      =   params$EUROSTAT, 
                      FIDES         =   params$FIDES, 
                      NationalStats =   params$NationalStats,
                      RCGstats      =   params$RCGstats)  # Flag to inform on which source to be used (FIDES=FALSE means the system wil use a public DB instead)
...
if (whatGoesIn$RCGstats) RCG <- loadRCG(pathIn)
```
