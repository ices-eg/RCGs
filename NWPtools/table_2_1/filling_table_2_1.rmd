...
# Change country and refence years in params in the YAML
...
# Output content - only controls the _filled not the _control
## Use c() for all | a list of RFMO's eg. c("ICES", "NAFO")

## RCGstats are only reliable in c("ICES", "NAFO") and have only been tested in these

rfmos_in_output <- c("ICES", "NAFO")
...
table_2.1_ref <- "EUMAP_Table_2_1_Linkage_EUROSTAT_RDB and EC_TAC.csv"
