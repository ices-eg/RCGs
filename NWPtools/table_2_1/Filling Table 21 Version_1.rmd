...
output_suffix <- gsub(":", "", paste("_RDB", Sys.time(), sep = "_"))
...
table_2.1$areaBis <- gsub(" ", "", table_2.1$areaBis) #kibi: Remove blanks in area codes - already done for areaRDB
```
