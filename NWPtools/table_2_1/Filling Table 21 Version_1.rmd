...
## Use All | a list of RFMO's eg. c("ICES", "NAFO")
...
```{r}
write.table(T2_1, file=paste(pathOut,paste(CTRY,"_table2_1_filled", output_suffix, ".csv",sep=''),sep='/'), sep=';',row.names=FALSE, quote=FALSE)
