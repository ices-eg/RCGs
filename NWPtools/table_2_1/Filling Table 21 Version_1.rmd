...
if (whatGoesIn$RCGstats){
  GEO_rdb <- read.csv(paste0(path, "GEO_RDB.csv"), sep = ";")
}
...
```{r}
write.table(T2_1, file=paste(path,paste(CTRY,'_table2_1_filled.csv',sep=''),sep='/'), sep=';',row.names=FALSE, quote=FALSE)
write.table(tabControl, file=paste(path,paste(CTRY,'_table2_1_control.csv',sep=''),sep='/'), sep=';',row.names=FALSE, quote=FALSE)
```
