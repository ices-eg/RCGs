...
knitr::opts_knit$set(root.dir = "Q:/20-forskning/20-dfad/users/joeg/home/Metier")
```
...
part1 <- input.data[1:5 , 1:8]   
part2 <- input.data[1:5 , 9:15]  
part3 <- input.data[1:5 , 16:19] 

# First table
kable(part1, booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position", position = "left")

# Second table
kable(part2, booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position", position = "left")

# Third table
kable(part3, booktabs = TRUE) %>%
  kable_styling(latex_options = "hold_position", position = "left")
...
```{r newtab, echo=FALSE}
part1 <- input.data[1:5 , 1:9]   
part2 <- input.data[1:5 , 10:15]  
part3 <- input.data[1:5 , 16:23]
part4 <- input.data[1:5 , 24:27]
...
part2 <- input.data[1:5 , 10:15]  
part3 <- input.data[1:5 , 16:23]
part4 <- input.data[1:5 , 24:29]
part5 <- input.data[1:5 , 30:31]
...
input.data <- input.data[order(mis_met_number_of_seq,vessel_id,trip_id,fishing_day,area,ices_rectangle,gear,mesh),]

part1 <- input.data[1:5 , 1:9]   
part2 <- input.data[1:5 , 10:15]  
part3 <- input.data[1:5 , 16:23]
part4 <- input.data[1:5 , 24:29]
part5 <- input.data[1:5 , 30:32]
...
part1 <- input.data[1:5 , 1:8]   
part2 <- input.data[1:5 , 9:15]  
part3 <- input.data[1:5 , 16:21]
part4 <- input.data[1:5 , 23:28]
part5 <- input.data[1:5 , 29:33]
part6 <- input.data[1:5 , 34:36]
...
part1 <- input.data[1:10 , 1:9]   
part2 <- input.data[1:10 , 10:16]  
part3 <- input.data[1:10 , 17:23]
part4 <- input.data[1:10 , 24:30]
part5 <- input.data[1:10 , 31:35]
part6 <- input.data[1:10 , 35:36]
...
input.data1 <- input.data[order(vessel_id,trip_id,fishing_day,area,ices_rectangle,gear,mesh),.(Country,RCG,year,vessel_id,vessel_length,trip_id,haul_id,fishing_day,area,ices_rectangle,gear,gear_FR,mesh,selection,FAO_species,
...
part1 <- input.data1[1:10 , 1:9]   
part2 <- input.data1[1:10 , 10:16]  
part3 <- input.data1[1:10 , 17:22]
part4 <- input.data1[1:10 , 23:27]
part6 <- input.data1[1:10 , 28:29]
...
input.data1 <- input.data[order(vessel_id,trip_id,fishing_day,area,ices_rectangle,gear,mesh),.(Country,RCG,year,vessel_id,vessel_length,trip_id,haul_id,fishing_day,area,ices_rectangle,gear,gear_FR,mesh,selection,FAO_species,
               ...
               detailed_metier_level_6,det_met6_number_of_seq,det_met6_level)][order(det_met6_number_of_seq)]

part1 <- input.data1[1:10 , 1:9]   
part2 <- input.data1[1:10 , 10:16]  
part3 <- input.data1[1:10 , 17:22]
part4 <- input.data1[1:10 , 23:25]
part5 <- input.data1[1:10 , 26:27]
part6 <- input.data1[1:10 , 28:29]
