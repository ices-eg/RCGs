missingMetiersByLevel<-function(input.data, level, sequence.def){
  input.data.metiers.missing<-input.data[metier_level_6=="MIS_MIS_0_0_0"]
  n.rows.initial<-nrow(input.data)
  data.with.metiers<-input.data[metier_level_6!="MIS_MIS_0_0_0",
  ...
  input.data.metiers.missing[is.na(metier_level_6),
                             ":="(metier_level_6="MIS_MIS_0_0_0", metier_level_5="MIS_MIS")]
  input.data<-input.data[metier_level_6!="MIS_MIS_0_0_0"]
