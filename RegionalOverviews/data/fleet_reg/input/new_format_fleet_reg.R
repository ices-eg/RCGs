...
{
eu_fleet_register<-read.csv2(paste("data\\fleet_reg\\input\\2019\\FLEET-",ctry,".csv",sep = ""), sep=";", header=T, row.names=NULL, as.is=T)
...
write.csv2(eu_fleet_register, file=paste("D:\\RCGs\\RegionalOverviews\\data\\fleet_reg\\output\\2019\\",ctry,"_export.csv",sep=""), row.names=F)	
}
