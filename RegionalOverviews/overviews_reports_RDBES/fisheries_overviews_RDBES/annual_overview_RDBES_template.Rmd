...
species_codes <- read.csv2("../../data/Species codes Worms and FAO.csv")
cl$SpecWormsCode <- cl$CLspeciesCode
cl <- merge(cl, species_codes, by = "SpecWormsCode") ## some sort of duplicate issue her
