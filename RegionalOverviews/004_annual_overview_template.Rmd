          ...
          if (tables == "yes") {
            write.table(
              ...
              row.names = F
                  ...
                  j<- i
        cat('Figure ',graph_det$Subsubsection[i],'.',j,'. ',graph_det$Var[i],' by ',graph_det$var1[i],'  \n ',sep='')
         cat('  \n ') 
  cat('text baaablaaa bla  \n ')
        ...
        if (graph_det$Graph_type[i] == 2)
        {
          ...
          if (tables == "yes") {
           ...
           j<- i
cat('Figure ',graph_det$Subsubsection[i],'.',j,'. blablabls  \n ',sep='')
#        cat('Figure ',graph_det$Subsubsection[i],'.',j,'. ',graph_det$Var[i],' by ',graph_det$var1[i],' and #',graph_det$var2[i],'  \n ')
         cat('  \n ') 
#  cat('2  \n ')
        }
...
#          j<- i
#        cat('Figure ',graph_det$Subsubsection[i],'.',j,'. ',graph_det$func[i],' of ',graph_det$var[i],' and #',graph_det$groupBy[i],'(',graph_det$addToTitle[i],')  \n ')
         cat('  \n ') 
#  cat('3  \n ')
        }
...
#           j<- i
#        cat('Figure ',graph_det$Subsubsection[i],'.',j,'. ',graph_det$func[i],' of ',graph_det$newVarName[i],' by #',graph_det$groupBy[i],'(',graph_det$addToTitle[i],')  \n ')
         cat('  \n ') 
#  cat(' 4 \n ')
        }
...
#  j<- i
#        cat('Figure ',graph_det$Subsubsection[i],'.',j,'. ',graph_det$newVarName[i],' by ',graph_det$addToTitle[i],'  \n ')
         cat('  \n ') 
#  cat(' 6 \n ')
        }
         cat('  \n ') 
