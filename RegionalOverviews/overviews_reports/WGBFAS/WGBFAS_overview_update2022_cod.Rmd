...
Plots and graphs presented in this document have been created based on the WGBFAS request. This overview refers to 2021 data for cod and is only for use by WGBFAS. 
...
species_code <- 126436 # Gadus morhua
Region <- "BS"
...
data_dir <- paste("C:/Dateien/Workshops und Fortbildungen/RCG Baltic/RCG Github/RCGs/RegionalOverviews/input_data/2022/", target_region, "/", sep = '') 
period <- "2022"

#Folder for figures and tables
 #table_dir <- paste("../../overviews_reports/WGBFAS/outputs/tables/", sep = "")
# table_dir <- paste("D:/Documents/PNAB/2022/000_RCG_InterssessionalWork/ISSG_Catch_Effort_Sampling_overviews/ISSG_overviews/RegionalOverviews/overviews_reports/WGBFAS/outputs/tables/", sep = "")

table_dir <- paste("C:/Dateien/Workshops und Fortbildungen/RCG Baltic/RCG Github/RCGs/RegionalOverviews/overviews_reports/WGBFAS/outputs/tables/", sep = "")



 #figur_dir <- paste("../../overviews_reports/WGBFAS/outputs/figures/", sep = "")
#figur_dir <- paste("D:/Documents/PNAB/2022/000_RCG_InterssessionalWork/ISSG_Catch_Effort_Sampling_overviews/ISSG_overviews/RegionalOverviews/overviews_reports/WGBFAS/outputs/figures/", sep = "")
figur_dir <- paste("C:/Dateien/Workshops und Fortbildungen/RCG Baltic/RCG Github/RCGs/RegionalOverviews/overviews_reports/WGBFAS/outputs/figures/", sep = "")
...
cat("  \n")
cat(paste0("## ", "Effort by metier level 5 \n"))
...
# Total landings and sampling position and number of samples by quarter and statistical rectangle.
          ...
          subchunkify(map0,"Figure_n_sample_CPUE_map",  10, 9)
          
          if (tables == "yes") {
            write.table(
              map0[[1]],
              file =  
                paste(table_dir, "Figure_n_sample_CPUE_map",
                ".txt",
                sep = ""
              ),
              sep = "\t",
...
# Annual total landings and sampling position and number of samples by statistical rectangle.
          ...
          subchunkify(map0,"Figure_n_sample_CPUE_map_HL_y",  10, 9)
...
cat("\n")
cat("**Figure 10.** Total landings, sampling position and number of samples by catch category and statistical rectangle in 2021.(source: HL data) \n ")
...
cat("  \n")
cat(paste0("## ", "Number of samples per unit of landings in 2021 \n")) #per CA
...
# Total landings and sampling position and number of samples by quarter and statistical rectangle.
          ...
          subchunkify(map0,"Figure_sample_n_CPUE_map_CA_y",  10, 9)
...
cat("\n")
cat("**Figure 12.** Total landings, sampling position and number of samples by statistical rectangle, in 2021. (source: CA data) \n ")
...
cat("  \n")
cat(paste0("## ", "Landing sampled weight per unit of landings in 2021 \n")) #per CA
...
cat("\n")
cat("**Figure 14.** Total landings, sampling position and landing sampled weights by statistical rectangle, in 2021. (source: CA data) \n ")
...
samplingVSlandings %>%
  ...
  mutate(NoLengthTrips = ifelse(NoLengthTrips==0, NA, NoLengthTrips))  -> samplingVSlandingsF_cod

matrix<-ggplot(samplingVSlandingsF_cod, aes(y = factor(FlagCountry),
...
cat("\n")
cat("**Figure 16.** Total landings and number of trips sampled with cod, by gear and country. \n ")
