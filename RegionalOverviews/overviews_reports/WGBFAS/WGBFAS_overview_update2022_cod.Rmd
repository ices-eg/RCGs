...
data_dir <- paste("C:/Dateien/Workshops und Fortbildungen/RCG Baltic/RCG Github/RCGs/RegionalOverviews/input_data/2021/", target_region, "/", sep = '') 
period <- "2021"
...
{
  load(
    paste(data_dir, "RDB_RCG_BA_CL_2009_2021_prepared_20220422.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_BA_CE_2009_2021_prepared_20220422.Rdata", sep = "")
  )
  load(
