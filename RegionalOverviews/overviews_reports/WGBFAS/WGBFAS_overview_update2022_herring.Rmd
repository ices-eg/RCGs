...
Plots and graphs presented in this document have been created based on the WGBFAS request. This overview refers to 2021 data for herring and is only for use by WGBFAS. 
...
species_code <- 126417 # Clupea harengus
Region <- "BS"
...
matrix<-ggplot(samplingVSlandingsF_sprat, aes(y = factor(FlagCountry),
  ...
  theme_bw()
          ...
          subchunkify(matrix,"Figure_sample_matrix_herring",  10, 9)
          
          if (tables == "yes") {
            write.table(
              matrix[[1]],
              file =  
                paste(table_dir, "Figure_sample_matrix_herring",
                ".txt",
                sep = ""
              ),
              sep = "\t",
...
cat("\n")
cat("**Figure 16.** Total landings and number of trips sampled with herring, by gear and country. \n ")
