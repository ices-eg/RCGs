---
title: "WGBFAS - *Pleuronectes platessa*"
...
Plots and graphs presented in this document have been created based on the WGBFAS request. This overview refers to 2021 data for plaice and is only for use by WGBFAS. 
...
species_code <- 127143 # Pleuronectes platessa
Region <- "BS"
...
samplingVSlandings %>%
  ...
  mutate(NoLengthTrips = ifelse(NoLengthTrips==0, NA, NoLengthTrips))  -> samplingVSlandingsF_plaice

matrix<-ggplot(samplingVSlandingsF_plaice, aes(y = factor(FlagCountry),
  ...
  theme_bw()
          ...
          subchunkify(matrix,"Figure_sample_matrix_plaice",  10, 9)
          
          if (tables == "yes") {
            write.table(
              matrix[[1]],
              file =  
                paste(table_dir, "Figure_sample_matrix_plaice",
                ".txt",
                sep = ""
              ),
              sep = "\t",
...
cat("\n")
cat("**Figure 16.** Total landings and number of trips sampled with plaice, by gear and country. \n ")
