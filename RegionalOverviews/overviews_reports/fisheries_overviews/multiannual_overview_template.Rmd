...
```{r title, include = F}
RCG <- "NSEA" # RCG_NA, RCG_BA or RCG_NSEA
...
if (RCG == "NA") {
  htmltools::img(src = knitr::image_uri(file.path("../../overviews_shiny/www/logo RCG NA NS_EA.png")), 
               alt = 'logo', 
               style = 'position:absolute; top:10; right:0; padding:10px;',width="300px", height="100px")
...
Warning: This stock allocation represents the RDB variable "stock", which is currently being updated. Therefore it was decided to adjust the "stock" variable bu the group. 
