...
```{r echo=FALSE, message=FALSE, warning = FALSE, out.width="90%", out.height="90%"}
		res_fleetreg<-table(fleetreg$Status_date, fleetreg$Country_Code)
print(res_fleetreg)
...
res_fleetreg_pwr<-t(res_fleetreg_pwr)
print(res_fleetreg_pwr)
...
res_fleetreg_gt<-t(res_fleetreg_gt)
print(res_fleetreg_gt)
