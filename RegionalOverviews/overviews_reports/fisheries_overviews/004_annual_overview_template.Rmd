...
data_dir <-data_dir <- paste("D:/Do przegrania na PC/IntersessionalWork/RCGs Data/", target_region, "/", sep = '') # 
...
table_dir <- paste("D:/Do przegrania na PC/IntersessionalWork/RCGs Outputs/", target_region, "/tables/", sep = "")
figur_dir <- paste("D:/Do przegrania na PC/IntersessionalWork/RCGs Outputs/", target_region, "/figures/", sep = "")
...
{
  load(
    paste(data_dir, "RDB_RCG_NA_CL_2009_2019_prepared_20200616.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NA_CE_2009_2019_prepared_20200616.Rdata", sep = "")
  )
}
...
{
  load(
    paste(data_dir, "RDB_RCG_BA_CL_2009_2019_prepared_20200616.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_BA_CE_2009_2019_prepared_20200616.Rdata", sep = "")
  )
}
if (target_region == "RCG_NSEA")
{
  load(
    paste(data_dir, "RDB_RCG_NSEA_CL_2009_2019_prepared_20200616.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NSEA_CE_2009_2019_prepared_20200616.Rdata", sep = "")
    )
			}	
