...
#data_dir <-data_dir <- paste("../../data/002_prepared/", target_region, "/", sep = '') 
...
{
  load(
    paste(data_dir, "RDB_RCG_NA_CL_2009_2022_prepared_20230426.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NA_CE_2009_2022_prepared_20230426.Rdata", sep = "")
  )
}
...
{
  load(
    paste(data_dir, "RDB_RCG_BA_CL_2009_2022_prepared_20230426.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_BA_CE_2009_2022_prepared_20230426.Rdata", sep = "")
  )
}
if (target_region == "RCG_NSEA")
{
  load(
    paste(data_dir, "RDB_RCG_NSEA_CL_2009_2022_prepared_20230426.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NSEA_CE_2009_2022_prepared_20230426.Rdata", sep = "")
    )
			}	
