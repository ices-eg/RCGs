...
#Paramters 
RDB_download_date <- "23/04/2022" # update the day
...
## Number of vessels
Number of vessels with fishing license, by flag country and length class in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`; red = number decreases; green = number increases; white = number maintains).
...
## Power
Power (1000*kW) of licensed vessels, by flag country and length class in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`).
...
## Gross tonnage
Gross Tonnage(1000*GT) of licensed vessels, by flag country and length class in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`).
