...
The present Catch and Effort Overview displays summary figures and tables of the 2020 landings and effort data found in tables CL and CE of the Regional Data Base (RDB). The RDB is a main resource used by the Regional Coordination Groups to coordinate data collection of EU fisheries. The RDB is hosted at the International Council for Exploration of the Sea (ICES) and its data is property of EU Member States with usage governed by the RDB data policy (https://www.ices.dk/data/Documents/Data_Policy_RDB.pdf). The data referring to the present year was collected under the RCG 2021 data call for the 2020 data for the Baltic Sea, North Sea, Eastern Arctic and the North Atlantic regions and download from the system on the 24th of April 2021 with the exception of information detailed in section “2. Overall Fleet Evolution” which was extracted from the EU Fleet Register (https://webgate.ec.europa.eu/fleet-europa/index_en) on the 14th of April 2021 Information how to read the main types of graphs and maps is displayed in Annex A.
