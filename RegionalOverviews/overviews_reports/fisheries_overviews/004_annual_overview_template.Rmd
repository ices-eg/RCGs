...
table_dir <- paste("D:/Documents/PNAB/2022/000_RCG_InterssessionalWork/ISSG_Catch_Effort_Sampling_overviews/ISSG_overviews/RegionalOverviews/outputs/",period,"/", target_region, "/tables/", sep = "")  # PC Ana

 figur_dir <- paste("D:/Documents/PNAB/2022/000_RCG_InterssessionalWork/ISSG_Catch_Effort_Sampling_overviews/ISSG_overviews/RegionalOverviews/outputs/",period,"/", target_region, "/figures/", sep = "") # PC Ana
...
{
  load(
    paste(data_dir, "RDB_RCG_NA_CL_2009_2021_prepared_20220422.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NA_CE_2009_2021_prepared_20220422.Rdata", sep = "")
  )
}
...
{
  load(
    paste(data_dir, "RDB_RCG_NSEA_CL_2009_2021_prepared_20220422.Rdata", sep = "")
  )
  load(
    paste(data_dir, "RDB_RCG_NSEA_CE_2009_2021_prepared_20220422.Rdata", sep = "")
    )
			}	
...
## Number of vessels
Number of EU licensed vessels by flag country and vessel length class present in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`; red = number decreases; green = number increases; white = number maintains).
...
## Power
Power (1000*kW) of EU licensed vessels by flag country and vessel length class present in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`).
...
## Gross tonnage
Gross Tonnage(1000*GT) of EU licensed vessels by flag country and vessel length class present in the EU vessel register (licence indicator == “Y” in 1st January `r years`. Parentesis: variation relative to `r years-1`).
