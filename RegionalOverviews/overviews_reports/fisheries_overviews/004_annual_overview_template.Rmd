...
data_dir <-data_dir <- paste("C:/use/0_GitHub/RCGs/RegionalOverviews/store_data/002_prepared/", target_region, "/", sep = '') # 
...
table_dir <- paste("C:/use/0_GitHub/RCGs/RegionalOverviews/", "tables/", sep = "")
figur_dir <- paste("C:/use/0_GitHub/RCGs/RegionalOverviews/", "figures/", sep = "")
