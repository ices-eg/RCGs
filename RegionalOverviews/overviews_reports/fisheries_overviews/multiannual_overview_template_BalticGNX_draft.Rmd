...
The present Catch and Effort Overview displays summary information on EU commercial landings (CL) and fishing effort (CE) statistics included in the Regional Data Base (RDB), which is used to store detailed commercial fisheries and sampling data. 
Only the gillneter fishery has been considered in this report, including GNS, GTR and GND
...
The following panels present the annual fishing effort by flag country for the different vessel length categories
...
### Days at sea - per vessel length category
...
### Landings - - per vessel length category
```{r echo=FALSE, message=FALSE, warning = FALSE, out.width="95%", out.height="95%"}
